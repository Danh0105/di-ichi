...
const goals = [
  "Biết tự phục vụ bản thân trong sinh hoạt hằng ngày",
  "Biết gấp quần áo, tất và sắp xếp đồ dùng gọn gàng",
  "Biết tự đánh răng, rửa mặt, thay quần áo",
  "Biết tự dọn dẹp đồ chơi sau khi sử dụng",
  "Biết sắp xếp sách vở và chuẩn bị cặp sách đến trường",
];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-slate-600">
                Cuộc sống luôn thay đổi và đòi hỏi các em phải biết tự chăm sóc
                bản thân, tự lập và có trách nhiệm với những việc làm hằng ngày.
                Kỹ năng tự phục vụ giúp các em hình thành thói quen tốt, rèn
                luyện tính ngăn nắp, chủ động và tự tin trong học tập cũng như
                cuộc sống.
              </p>
